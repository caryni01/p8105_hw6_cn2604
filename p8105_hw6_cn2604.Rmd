...
model_2 = lm(bwt ~ bhead*blength*babysex, data = birth_df)
...
The result shows that the model from elastic net has lowest rmse which shows best predictive accurancy compared to two other models. 
